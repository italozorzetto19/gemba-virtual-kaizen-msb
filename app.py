    ...
    return pd.DataFrame([
        {
            ...
            "entradas": "Relato de cliente, reclamação, sugestão, dúvida ou demanda recebida em visita, WhatsApp, ligação ou e-mail",
            "processo": "Informação chega de forma informal e pode ficar concentrada no comercial, sem padronização ou rastreabilidade",
            "saidas": "Entrada VOC estruturada e priorizada",
            "clientes": "Engenharia / Qualidade / Comercial",
        },
        {
            "fornecedores": "Vendedor / Representante",
            "entradas": "Pedido de nova medida, novo modelo, alteração em kit ou sugestão de melhoria de produto",
            "processo": "Registro no app VOC com identificação do produto, origem da informação, descrição e evidência quando houver",
            "saidas": "Demanda técnica para avaliação de portfólio",
            "clientes": "Engenharia / P&D / Comercial",
        },
        {
            "fornecedores": "Médico",
            "entradas": "Dificuldade de uso, sugestão de desempenho, comparação com concorrente ou necessidade clínica não atendida",
            "processo": "Classificação da voz do cliente por tipo de entrada: reclamação, melhoria, demanda, dúvida, elogio ou benchmarking",
            "saidas": "Requisito técnico preliminar ou oportunidade de melhoria",
            "clientes": "Engenharia / P&D / Qualidade",
        },
        {
            "fornecedores": "Hospital / Comprador",
            "entradas": "Solicitação de documentação, cadastro, código, embalagem, prazo, disponibilidade ou configuração específica",
            "processo": "Separação entre demanda comercial, documental, logística e técnica",
            "saidas": "Direcionamento correto da solicitação",
            "clientes": "Comercial / Regulatórios / Engenharia / Logística",
        },
        {
            "fornecedores": "Distribuidor",
            "entradas": "Informação sobre mercado regional, perda de venda, produto concorrente, necessidade de preço ou produto ausente no portfólio",
            "processo": "Registro como sinal de mercado e análise de recorrência",
            "saidas": "Oportunidade comercial ou técnica",
            "clientes": "Comercial / Engenharia / Diretoria",
        },
        {
            "fornecedores": "Qualidade / SAC",
            "entradas": "Reclamação formal, falha percebida, desvio, possível não conformidade ou evento com impacto no uso",
            "processo": "Triagem para diferenciar reclamação de cliente, problema técnico, uso incorreto ou necessidade de investigação",
            "saidas": "Registro para investigação e possível ação corretiva",
            "clientes": "Qualidade / Engenharia / Regulatórios",
        },
        {
            "fornecedores": "Engenharia",
            "entradas": "Ideia técnica, melhoria de projeto, alteração de material, melhoria de processo ou oportunidade de redução de custo",
            "processo": "Avaliação preliminar de viabilidade técnica, impacto regulatório e impacto no produto",
            "saidas": "Proposta de estudo técnico ou melhoria de produto",
            "clientes": "P&D / Qualidade / Produção / Compras",
        },
        {
            "fornecedores": "Produção",
            "entradas": "Dificuldade de montagem, retrabalho, variação no processo, melhoria de dispositivo ou oportunidade de simplificação",
            "processo": "Registro de oportunidade interna relacionada ao produto ou processo",
            "saidas": "Ideia de melhoria interna",
            "clientes": "Engenharia / Processos / Qualidade",
        },
        {
            "fornecedores": "Regulatórios",
            "entradas": "Dúvida sobre IFU, rotulagem, símbolo, cadastro, descrição técnica ou exigência documental",
            "processo": "Análise se a dúvida indica falha de informação, necessidade de revisão documental ou impacto regulatório",
            "saidas": "Demanda de revisão de documento, IFU ou rotulagem",
            "clientes": "Regulatórios / Engenharia / Qualidade",
        },
        {
            "fornecedores": "Logística / Expedição",
            "entradas": "Problema de embalagem, identificação, volume, acondicionamento, transporte ou reclamação de entrega",
            "processo": "Classificação entre problema logístico, embalagem técnica ou necessidade de melhoria de identificação",
            "saidas": "Melhoria de embalagem ou ajuste logístico",
            "clientes": "Logística / Engenharia / Qualidade",
        },
        {
            "fornecedores": "Fornecedor",
            "entradas": "Novo material, componente, conector, tubo, embalagem, tecnologia produtiva ou alternativa de redução de custo",
            "processo": "Registro como oportunidade técnica ou alternativa de fornecimento",
            "saidas": "Oportunidade de inovação, nacionalização ou redução de custo",
            "clientes": "Engenharia / Compras / P&D",
        },
        {
            "fornecedores": "Agente Radar",
            "entradas": "Artigo, patente, edital, catálogo, site de concorrente, nova tecnologia ou tendência de mercado",
            "processo": "Pesquisa online, resumo do achado, classificação e registro na base VOC / inovação",
            "saidas": "Achado de mercado estruturado",
            "clientes": "Engenharia / P&D / Comercial",
        },
        {
            "fornecedores": "Feira / Congresso",
            "entradas": "Produto novo visto no mercado, tecnologia emergente, solução de concorrente ou necessidade relatada por cliente",
            "processo": "Registro do achado com foto, catálogo, link ou descrição do diferencial observado",
            "saidas": "Benchmarking ou oportunidade de portfólio",
            "clientes": "Engenharia / P&D / Marketing",
        },
        {
            "fornecedores": "Cliente final / Usuário",
            "entradas": "Elogio sobre facilidade de uso, desempenho, embalagem, identificação ou qualidade percebida",
            "processo": "Registro como ponto forte do produto e evidência positiva de uso",
            "saidas": "Histórico de ponto forte do produto",
            "clientes": "Engenharia / Comercial / Marketing",
        },
        {
            "fornecedores": "Treinamento técnico",
            "entradas": "Dúvida recorrente sobre preparo, uso, medida, compatibilidade, embalagem, IFU ou descarte",
            "processo": "Análise se a dúvida indica necessidade de treinamento, revisão de IFU ou melhoria de usabilidade",
            "saidas": "Necessidade de treinamento ou revisão técnica",
            "clientes": "Engenharia / Regulatórios / Comercial",
        },
        {
            "fornecedores": "Concorrente / Mercado",
            "entradas": "Produto concorrente com medida, kit, acessório, embalagem, material ou desempenho diferente",
            "processo": "Registro como benchmarking e comparação com portfólio MSB",
            "saidas": "Oportunidade de diferenciação ou melhoria",
            "clientes": "Engenharia / Comercial / P&D",
        },
        {
            "fornecedores": "Diretoria / Gestão",
            "entradas": "Direcionamento estratégico, necessidade de novo mercado, redução de custo ou expansão de portfólio",
            "processo": "Transformação da diretriz em entrada estruturada para análise técnica e comercial",
            "saidas": "Tema estratégico para estudo",
            "clientes": "Engenharia / Comercial / P&D / Compras",
        },
        {
            "fornecedores": "",
            "entradas": "",
